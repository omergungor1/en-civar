                                            ...
                                            <div className="flex space-x-2">
                                                {business.phone && (
                                                    <a
                                                        ...
                                                        className="flex items-center px-3 py-1 bg-primary-500 text-white text-sm rounded-md hover:bg-primary-600 transition-colors"
                                                    >
                                                ...
                                                <a
                                                    href={`/${city.slug}/${district.slug}/${business.slug}`}
