...
export default function BusinessCard({ business, index, categoryName }) {
    ...
    return (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden flex flex-col hover:shadow-md transition-shadow h-86">
                ...
                {business.phone && (
                    <div className="flex gap-2 mt-2">
                        <a
                            ...
                            className="flex items-center justify-center px-3 py-2 bg-[#FF6000] text-white text-sm rounded-md hover:bg-[#ea580c] transition-colors flex-1 md:w-auto"
                        >
                        ...
                        <a
                            ...
                            className="flex items-center justify-center px-2 py-2 bg-green-500 text-white text-sm rounded-md hover:bg-green-600 transition-colors w-12 md:w-auto md:px-3"
                        >
