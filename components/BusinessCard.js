...
export default function BusinessCard({ business, index }) {
    ...
    return (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden flex flex-col hover:shadow-md transition-shadow h-96">
            ...
            {/* İşletme Bilgileri - Tıklanabilir */}
            <div className="p-4 flex-1 flex flex-col hover:bg-gray-50 transition-colors">
                <div className="mb-3" >
                    <div className="flex items-center space-x-1 justify-between">
                        <h3 className="text-lg font-semibold text-gray-900 mb-1 hover:text-[#FF6000] transition-colors">{business.name}</h3>
                        {/* Rating */}
